...
bool InventoryChangeFailureAction::Execute(Event event)
{
    ...
    if (messages.empty())
    {
        ...
        messages[EQUIP_ERR_NO_REQUIRED_PROFICIENCY] = "我还不会使用这件物品";
        ...
        messages[EQUIP_ERR_CANT_DO_RIGHT_NOW] = "我还不能这样做";
        ...
        messages[EQUIP_ERR_INVENTORY_FULL] = "我的背包已经满了";
        ...
        messages[EQUIP_ERR_NOT_IN_COMBAT] = "我在战斗中";
