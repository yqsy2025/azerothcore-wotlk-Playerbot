...
public:
    ...
    void AddNewAuctions(std::vector<ObjectGuid> const& botGuids,
        FactionSpecificAuctionHouseConfig* config);

    void AddNewAuctionBuyerBotBid(std::vector<ObjectGuid> const& botGuids,
        FactionSpecificAuctionHouseConfig* config);
